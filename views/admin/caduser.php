								...
								<div class="card-header">
									<div class="row row-nav-line">
										<ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
											<li class="nav-item"> <a class="nav-link active show" data-toggle="tab" href="#home" role="tab" aria-selected="true">Cadastrar Usuários</a> </li>
                                    ...
                                    <div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-floating-label">
												...
												<label for="selectFloatingLabel" class="placeholder">Selecione o Objetivo do Treino</label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-floating-label">
												<select class="form-control input-border-bottom" id="genero" required>
													<option value="0">&nbsp;Escolha uma das opções</option>
													<option>Secando as Gordurinhas</option>
													<option>Ficando Birllll</option>
													<option>Massa magrela</option>
												</select>
												<label for="selectFloatingLabel" class="placeholder">Selecione o Treino mais apropriado</label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-floating-label">
												...
												<label for="selectFloatingLabel" class="placeholder">Selecione o Dieta mais apropriado</label>
											</div>
										</div>
									</div>
                                    <br>
