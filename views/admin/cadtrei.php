		...
		<div class="main-panel">
			<div class="content">
				<div class="page-inner">
					<h4 class="page-title">Cadastrar Treinos</h4>
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
									<div class="row row-nav-line">
										<ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
											<li class="nav-item"> <a class="nav-link active show" data-toggle="tab" href="#home" role="tab" aria-selected="true">Cadastrar Treinos</a> </li>
									...
									<div class="row mt-3">
										<div class="col-md-6">	
											<div class="form-group form-floating-label">
												...
												<label for="inputFloatingLabel" class="placeholder">Insira nome do Treino</label>
											</div>
										</div>
										<div class="col-md-6">	
											<div class="form-group form-floating-label">
									...
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group">
												<label for="imagem">Insira a imagem do Treino</label>
